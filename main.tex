...
\SetTitle{New Methods, Tools and Techniques for the Evolutionary Determination of Ensembles of Pareto Efficient Parameterizations of Classical Potentials with Applications}
...
%\include{chapter4/body} % PROBABILITY METHODS
% \include{chapter5/body} %
% \include{chapter6/body} % SOFTWARE DEVELOPMENT
\include{chapter7/ionic} % APPLICATION TO IONIC SOLIDS
\include{chapter8/body} % EAM POTENTIAL DEVELOPMENT
\include{appendix_A_point_defect/body}
% \include{chapter10/body}
...
\bibliography{bib/sample,chapter2/body,chapter3/chapter3,chapter7/ionic,chapter8/eam,appendix_A_point_defect/pointdefect.bib}
%chapter1/body.bib,chapter2/body.bib,chapter3/body.bib,chapter4/body.bib,chapter5/body.bib,chapter6/body.bib,chapter7/body.bib,chapter8/body.bib,chapter9/body.bib,chapter10/body.bib}
