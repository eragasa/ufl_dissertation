...
\include{chapter1/body} % INTRODUCTION
\include{chapter2/body} % COMPUTATIONAL TOOLS
\include{chapter3/body} % PARETO
%\include{chapter4/body} % PROBABILITY METHODS
\include{chapter5/body} % DESCRIPTION OF THE FITTING METHOD
\include{chapter6/body} % SOFTWARE DEVELOPMENT
\include{chapter7/ionic} % APPLICATION TO IONIC SOLIDS
\include{chapter8/body} % Si
\include{chapter9/body} % EAM POTENTIAL DEVELOPMENT
%\include{chapter10/body} % MACHINE LEARNING
\include{chapter11/body} % CONCLUSION
%\include{appendixA/body}
%\include{appendixB/body}
%\include{appendixC/body} % test pareto problems
%-----------------------------------------------------------------------%
...
\bibliography{chapter2/body,chapter3/body,chapter4/body,chapter5/body,chapter6/body,chapter7/ionic,chapter8/body,chapter9/eam.bib}
